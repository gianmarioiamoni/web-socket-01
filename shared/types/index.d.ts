...
export interface ServerToClientEvents {
    ...
    "task:moved": (taskId: string, fromColumnId: string, toColumnId: string, position: number) => void;
...
export interface ClientToServerEvents {
    ...
    "chat:send": (message: Omit<ChatMessage, "id" | "timestamp" | "userId" | "username">) => void;
    "chat:typing": () => void;
